        ...
        <div className="{styles.profileCard}">
            <div className="{styles.cardHeader}">
                ...
                <div className="{styles.profileImage}">
                    <img src="https://img.freepik.com/premium-vector/man-avatar-icon-flat-illustration-man-avatar-vector-icon-isolated-white-background_98396-5720.jpg?semt=ais_hybrid&w=740&q=80"
                    alt="Profile"/>
                </div>
            </div>
